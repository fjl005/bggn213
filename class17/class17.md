...
First, we need to go in the console and install the package. Biocmanager::install("RCy3")
...
![](class17_files/figure-markdown_github/unnamed-chunk-5-1.png)
...
```
    ...
    ##  [1] "BioPAX"               "BioPAX_SIF"           "Universe"            
    ##  [4] "Marquee"              "Big Labels"           "Curved"              
    ##  [7] "Solid"                "default"              "Sample1"             
    ## [10] "Sample2"              "Directed"             "Ripple"              
    ## [13] "Minimal"              "default black"        "Sample3"             
    ## [16] "Gradient1"            "Nested Network Style" "size_rank"
...
```
    ...
    ## + 845/845 vertices, named, from c0386f6:
...
```
    ...
    ## + 1544/1544 edges from c0386f6 (vertex names):
